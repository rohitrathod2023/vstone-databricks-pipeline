...
def build_checked_locations(bronze_df: DataFrame) -> DataFrame:
    ...
    Returns:
        ...
        longitude: double) plus a rejection_reason column. silver_locations
        and silver_locations_rejected are both derived by filtering this
        same DataFrame (see quarantine.valid_rows/rejected_rows).
